...
# ['Bending', 'SittingDown', 'ClosingCan', 'Reaching', 'Walking', 'Drinking', 'StairsClimbingUp',
...
# 55752f
# 1a476f
total_posses = miss_p[0, act, :] + correct_p[0, act, :]

xvals = miss_p[0, act, :]
pos_t = correct_p[0, act, :]
...
plt.savefig('/home/reza/PycharmProjects/RHM-HAR-SK-Dataset/HrNet/pos-Bending.png')
plt.show()
